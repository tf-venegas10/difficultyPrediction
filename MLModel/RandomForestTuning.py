...
while n_estimators <= 10000:
    ...
    while max_depth <= 1000:
        # initialize models
        forest = RandomForestClassifier(n_estimators=n_estimators, max_depth=max_depth, random_state=111)
        models = [forest]
        names = ["Random Forest"]
        ...
        if 'allFeatures' not in results.keys():
            ...
            results['allFeatures']['max_depth'].append(max_depth)
        ...
        #     results['lowVariance']['max_depth'].append(max_depth)
        #
        # if mean > bestMean:
        #     bestModel, bestName, bestMean = model, name, mean
        #     x_best = x_case
        ...
        #     results['univariate']['max_depth'].append(max_depth)
        #
        # if mean > bestMean:
        #     bestModel, bestName, bestMean = model, name, mean
        #     x_best = x_case
        ...
        #     results['backwards_elimination']['max_depth'].append(max_depth)
...
export = open("RandomForestTuningSubSett1.json", "w")
export.write(dumps)
export.close()
